...
const UpdateProduct = () => {
  ...
  // Fix date issue
  if (!productToSend.releaseDate) {
    productToSend.releaseDate = null;
  }

  // Ensure numbers are numbers
  productToSend.price = Number(productToSend.price);
  productToSend.stockQuantity = Number(productToSend.stockQuantity);
  ...
  updatedProduct.append(
    "product",
    new Blob([JSON.stringify(productToSend)], {
              ...
              <form className="row g-3" noValidate validated={validated.toString()} onSubmit={handleSubmit}>
                ...
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <option value="Intraocular Lenses">Intraocular Lenses</option>
                    <option value="Surgical Instruments">Surgical Instruments</option>
                    <option value="Phaco Equipment">Phaco Equipment</option>
                    <option value="Consumables">Consumables</option>
                    <option value="Ophthalmic Solutions">Ophthalmic Solutions</option>
                    <option value="Sterile Packs">Sterile Packs</option>
                  </select>
